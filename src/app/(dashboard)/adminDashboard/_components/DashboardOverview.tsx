      ...
      <div className="mx-auto max-w-7xl space-y-8">
              ...
              {chartData.map((item, index) => (
                ...
                >
                  ...
                  <div
                    ...
                    className="w-full rounded-t-md bg-purple-100 transition-all duration-300 group-hover:bg-purple-600"
                  />
                </div>
              ))}
            </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
          <div className="flex items-center justify-between border-b border-slate-100 p-6">
            ...
            <button className="inline-flex items-center gap-1 text-xs font-bold text-purple-600 transition hover:text-purple-700">
