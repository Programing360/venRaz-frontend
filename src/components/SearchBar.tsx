    ...
    <div ref={containerRef} className="relative w-full">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-200 bg-gray-50 py-2 pl-10 pr-9 text-sm text-slate-700 outline-none transition focus:border-[#ff594d] focus:bg-white focus:ring-2 focus:ring-[#ff594d]/20"
        />
        {query && (
          <button
            type="button"
